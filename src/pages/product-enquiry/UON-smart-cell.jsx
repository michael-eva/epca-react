    ...
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
        ...
        <div className="h-full">
          <div className="relative h-full">
            ...
            <div className="h-full" id="imageCarousel">
              <img src="" alt="E-777 Front View" className="w-full h-full object-cover" />
            </div>
            {/* Navigation arrows */}
      ...
      <div className="w-full md:w-1/3 bg-white overflow-y-auto h-[50vh] md:h-screen">
        <div className="p-12 pt-24">
          <h1 className="text-4xl font-medium mb-4 text-center">UON SMART™ CELL </h1>
          ...
          <form className="space-y-16">
            ...
            {/* Options */}
            <div className="space-y-6">
              <h2 className="text-2xl font-medium mb-6">Options</h2>
              <div className="space-y-4">
                <label className="flex items-center justify-between p-6 border-2 border-gray-200 rounded-xl hover:border-[#00CC66] hover:shadow-lg transition-all cursor-pointer group">
                  <span className="text-lg group-hover:text-[#00CC66]">Battery Diagnostics and System Monitoring™ (BDSM)</span>
                ...
                <label className="flex items-center justify-between p-6 border-2 border-gray-200 rounded-xl hover:border-[#00CC66] hover:shadow-lg transition-all cursor-pointer group">
                  <span className="text-lg group-hover:text-[#00CC66]">eGovernor tyre manager™ (GTM)</span>
                  <div className="flex items-center gap-3">
                    <input type="checkbox" className="w-5 h-5 form-checkbox text-[#00CC66] rounded" />
                    <button type="button" className="text-gray-400 hover:text-[#00CC66] text-lg">ⓘ</button>
                  </div>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-medium mb-6 flex items-center">
                Training
                <button type="button" className="ml-2 text-gray-400 hover:text-[#00CC66] text-lg">ⓘ</button>
              </h2>
              <div className="space-y-4">
                <label className="flex items-center justify-between p-6 border-2 border-gray-200 rounded-xl hover:border-[#00CC66] hover:shadow-lg transition-all cursor-pointer group">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-medium mb-6">Warranty Information</h2>
              <div className="p-6 border-2 border-gray-200 rounded-xl">
                <p className="text-gray-600">Standard warranty includes 12 months parts and labor coverage. Extended warranty options available upon request.</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <input type="text" placeholder="Location" className="w-full p-4 text-lg border-2 border-gray-200 rounded-xl focus:border-[#00CC66] focus:ring-2 focus:ring-[#00CC66]/20 focus:outline-none transition-all" />
