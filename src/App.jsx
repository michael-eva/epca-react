...
import EngineeringServices from './pages/product-info/engineering-services'
import E988 from './pages/product-info/E-988'
...
import GreenFleetProvider from './pages/GreenFleetProvider.jsx'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/product-info/engineering-services" element={<EngineeringServices />} />
        <Route path="/product-info/UON-smart-cell" element={<EngineeringServices />} />
        <Route path="/product-info/E-988" element={<E988 />} />
        ...
        <Route path="/green-fleet-provider" element={<GreenFleetProvider />} />
